...
<html lang="en">
  <head>
    <title>The Vault - The Games (Member Home Page)</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/vault.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Game Vault - Member Home Page</h1>
                <p class="mb-0">What games are in the vault?</p>
              </div>
            </div>
          ...
          <div class="col-lg-8">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                  ...
                  <div class="d-block d-md-flex listing vertical">
                      <a href="#.html" class="img d-block" style="background-image: url('images/mass-effect-t.png')"></a>
                      <div class="lh-content">
                        <span class="category">Multiplayer</span><span class="category">Shooter</span><span class="category">Single Player</span>
                        <span class="category">Sci-Fi</span><span class="category">Romance</span><span class="category">Action & Adventure</span>
                        <span class="category">RPG</span>
                        <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                        <h3><a href="Games/#.html">Mass Effect 3</a></h3>
                        <p class="mb-0">
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-Warning"></span>
                          <span class="review">(60,657 Reviews)</span>
                        </p>
                      </div>
              ...
              <div class="col-lg-6">
                  ...
                  <div class="d-block d-md-flex listing vertical">
                      <a href="#.html" class="img d-block" style="background-image: url('images/undertale.png')"></a>
                      <div class="lh-content">
                        <span class="category">Indie</span><span class="category">RPG</span><span class="category">Single Player</span>
                        <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                        <h3><a href="Games/#.html">Undertale</a></h3>
                        <p class="mb-0">
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-Warning"></span>
                          <span class="review">(95,322 Reviews)</span>
                        </p>
                      </div>
              ...
              <div class="col-lg-6">
                  ...
                  <div class="d-block d-md-flex listing vertical">
                      <a href="#.html" class="img d-block" style="background-image: url('images/super.png')"></a>
                      <div class="lh-content">
                        <span class="category">Indie</span><span class="category">Shooter</span><span class="category">Single Player</span>
                        <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                        <h3><a href="Games/#.html">Superhot</a></h3>
                        <p class="mb-0">
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-Warning"></span>
                          <span class="review">(34,642 Reviews)</span>
                        </p>
                      </div>
              ...
              <div class="col-lg-6">
                  ...
                  <div class="d-block d-md-flex listing vertical">
                      <a href="#.html" class="img d-block" style="background-image: url('images/need.png')"></a>
                      <div class="lh-content">
                        <span class="category">Cars & Racing</span><span class="category">Simulator</span><span class="category">Single Player</span>
                        <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                        <h3><a href="Games/#.html">Need For Speed: Rivals</a></h3>
                        <p class="mb-0">
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-warning"></span>
                          <span class="icon-star text-secondary"></span>
                          <span class="review">(22,537 Reviews)</span>
                        </p>
                      </div>
...
<<<<<<< HEAD
=======
            <!-- inserted test change for functionality here here-->
            <div class="site-section bg-light">
              <div class="container">
                <div class="row mb-10">
                  <div class="col-md-8 text-left border-primary">
                    <h2 class="font-weight-light text-primary">functionality test</h2>
>>>>>>> parent of 78e0ec9... Update listings.html
          </div>
        </div>
        <div class="row mt-5">
          <div class="col-lg-6">
    ...
    <div class="newsletter bg-primary py-5">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <h2>Newsletter</h2>
            <p>Sign up for the newsletter to get updates about whats getting added!</p>
          </div>
          <div class="col-md-6">
